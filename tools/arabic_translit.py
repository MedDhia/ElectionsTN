...
* an initial consonant pair takes an `a` between its letters (`همامي` ->
  `Hamami`), which is where the doubled consonant of `Hammami` comes from;
...
def translit(name):
    """A readable Latin rendering of one Arabic surname."""
