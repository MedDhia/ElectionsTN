...
- **[`maps/README.md`](maps/README.md)** — 558 figures (1,360 files) in eleven
...
python3 tools/make_surname_leaders.py          # the largest name per imada, and the six commonest on one map
